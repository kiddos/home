...
<div class="w3-container" style="width:88%;margin:auto">
	...
	<div style="margin-top:10px;margin-bottom:10px">
		...
		<div class="image" style="<?php echo "border: 1px solid $color";?>">
			<img class="preview" src="http://192.168.0.100/pictures/2013-12-1/RIMG0060.JPG" alt="preview1">
		</div>
		<div class="image" style="<?php echo "border: 1px solid $color";?>">
			<img class="preview" src="http://192.168.0.100/pictures/2013-12-1/RIMG0060.JPG" alt="preview2">
		</div>
		<div class="image" style="<?php echo "border: 1px solid $color";?>">
			<img class="preview" src="http://192.168.0.100/pictures/2013-12-1/RIMG0060.JPG" alt="preview3">
		</div>
		<div class="image" style="<?php echo "border: 1px solid $color";?>">
			<img class="preview" src="http://192.168.0.100/pictures/2013-12-1/RIMG0060.JPG" alt="preview4">
		</div>
		<div class="image" style="<?php echo "border: 1px solid $color";?>">
			<img class="preview" src="http://192.168.0.100/pictures/2013-12-1/RIMG0060.JPG" alt="preview5">
		</div>
